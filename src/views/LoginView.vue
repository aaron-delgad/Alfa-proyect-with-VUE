  ...
  <div class="wrapper fadeInDown">
    <div id="formContent">
      <div class="fadeIn first">
        <img src="@/assets/img/Making-Connexion_Logo.png" id="icon" alt="User Icon" />
      </div>
      ...
      <form>
        ...
        />
        <md-progress-bar class="md-accent" md-mode="indeterminate" v-if="activeSpinner"></md-progress-bar>
      </form>
